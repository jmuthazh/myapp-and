    ...
    public void onAttach(Context context) {
       ...
       mStartButton.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               v.getContext().startActivity(consentIntent);
               getActivity().finish();
            /*  ConsentFragment consentFragment = new ConsentFragment();
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction =        fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.fragment_container , consentFragment);
   ...
   /* @Override
    public void onViewCreated(View v, final Bundle savedInstanceState) {
        ...
        mStartButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent consentIntent = new Intent(getActivity(),ConsentFragment.class );
